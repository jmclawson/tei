...
<xsl:stylesheet version="1.0"
  ...
  exclude-result-prefixes="xsl tei xd eg fn #default">
	...
	<xsl:param name="teibpJS" select="concat($filePrefix,'/js/teibp-clawson.js')"/>
	<xsl:param name="theme.default" select="concat($filePrefix,'/css/emoji.css')"/>
	<xsl:param name="theme.emoji" select="concat($filePrefix,'/css/emoji.css')"/>
  ...
  <xsl:template name="grab-css">
	...
	<xsl:template name="teibpToolbox">
		<div id="teibpToolbox">
			...
			<!-- JMC: To add different Toolbox toggles, modify things below -->
			<label for="SpeechToggle">Hide dialogue</label>
			<input type="checkbox" id="SpeechToggle" /><br/>
			<label for="StageToggle">Hide stage directions</label>
			<input type="checkbox" id="StageToggle" /><br/>
			(<label for="MusicToggle">Hide interludes</label>
			<input type="checkbox" id="MusicToggle" />)<br/>
			<label for="RhymeToggle">Hide rhyme scheme</label>
			<input type="checkbox" id="RhymeToggle" /><br/>
			<!--<label for="EmojiToggle">Hide emoji</label>
			<input type="checkbox" id="EmojiToggle" /><br/>-->
			<!-- JMC: To add different Toolbox toggles, modify things above-->
			<!--<div>
				<h3>Themes:</h3>
