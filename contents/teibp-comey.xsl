...
<xsl:stylesheet version="1.0"
  ...
  exclude-result-prefixes="xsl tei xd eg fn #default">
	...
	<xsl:param name="teibpJS" select="concat($filePrefix,'/js/teibp-comey.js')"/>
  ...
  <xsl:template name="grab-css">
	...
	<xsl:template name="teibpToolbox">
		<div id="teibpToolbox">
			...
			<label for="PronounToggle">Blame game</label>
			<input type="checkbox" id="PronounToggle" /><br/>
			<label for="PartyToggle">Party time</label>
			<input type="checkbox" id="PartyToggle" /><br/>
